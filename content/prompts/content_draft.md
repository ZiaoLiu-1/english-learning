...
**术语零假设（硬规则，违反=返工）**：学习者不懂任何语法术语。任何语法术语——
主语、谓语、宾语、表语、系动词、补语、间接宾语/直接宾语、宾语补足语、成分、时态、
单复数、可数/不可数、冠词、代词、物主代词、介词、从句…——**第一次出现时必须当场用
一句大白话解释它是什么/在句子里管什么**（可配一个例子指出来），不能只甩术语。
且**前后用词一致**：同一个概念别一会儿叫"动词"一会儿叫"谓语"却不说明两者关系
（如需两种叫法，要点破"谓语就是句子里当动词用的那部分"）。跨课沿用：前面课已解释过的
术语后面课可直接用，但要确保它**确实在更早的已学课里被解释过**（读前置课程文件核对）。
...
（≤800 个汉字，仍以精炼为先——放宽只为给术语解释留空间，不是让你灌水。
中文思维 vs 英文思维对照。术语首现必解释，见上"术语零假设"。）
